About pytesseract-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytesseract-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7083&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytesseract-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytesseract` can be installed with `conda`:
...
It is possible to list all of the versions of `pytesseract` available on your platform with `conda`:
...
```
mamba search pytesseract --channel conda-forge
```
...
mamba repoquery search pytesseract --channel conda-forge

# List packages depending on `pytesseract`:
mamba repoquery whoneeds pytesseract --channel conda-forge

# List dependencies of `pytesseract`:
mamba repoquery depends pytesseract --channel conda-forge
```
